  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-lg-offset-3 p404 centered">
        <img src="./resources/clientMain/img/500.png" alt="">
        <h1>ERROR</h1>
        <h3>뭔가 잘못됐습니다..... 메인으로 돌아갑니다.......</h3>
        <br>
        <div class="row">
          <div class="col-md-8 col-md-offset-2">
            <button class="btn btn-primary btn-lg" onclick="location.href ='clientNoticeList'">메인 가기</button>
          </div>
        </div>
      </div>
    </div>
